...
public class DisplacementMeasuredUnitQueryInputActivity extends Activity{
	
	private final static String TAG=DisplacementMeasuredUnitQueryInputActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_displacementmeasuredunitqueryinput);
		...
		confrimLl.setOnClickListener(new View.OnClickListener()
				{
					...
					public void onClick(View arg0) {
						...
						if (nameAndToken!=null && nameAndToken.size()==2) {
							Intent intent = new Intent(DisplacementMeasuredUnitQueryInputActivity.this, DisplacementMeasuredUnitQueryWaitActivity.class);
    ...
    TextView.OnClickListener bottomListener = new TextView.OnClickListener(){//创建监听对象    
        ...
        {    
            ...
            ((Activity)DisplacementMeasuredUnitQueryInputActivity.this).finish();
			}
		}
    };  
