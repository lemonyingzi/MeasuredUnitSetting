...
import com.measuredunitsetting.displacement.query.DisplacementMeasuredUnitQueryWaitActivity;
import com.measuredunitsetting.global.GlobalVariable;
import com.measuredunitsetting.hydraulic.query.HydraulicMeasuredUnitQueryWaitActivity;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void handleDecode(Result rawResult, Bundle bundle) {
		...
		if (rawResult.getText()!=null) {
			String[] nameAndId=rawResult.getText().split("-");
			if (nameAndId.length==2 && nameAndId[0].equals(getResources().getString(R.string.hydraulicCode))) {
				bundle.putString("id", nameAndId[1]);
				//数据库
				...
				{
					startActivity(new Intent(CaptureActivity.this, HydraulicMeasuredUnitQueryWaitActivity.class).putExtras(bundle));
				}
				else
				{
			...
			else if (nameAndId.length==2 && nameAndId[0].equals(getResources().getString(R.string.displacementCode))) {
				bundle.putString("id", nameAndId[1]);
				UserDB userDB=new UserDB(getApplicationContext(), GlobalVariable.getDataBaseName(), null, 7);
				List<String> nameAndToken=userDB.getNameAndToken();

				if (nameAndToken!=null && nameAndToken.size()==2) {
					startActivity(new Intent(CaptureActivity.this, DisplacementMeasuredUnitQueryWaitActivity.class).putExtras(bundle));
				}
				else
				{
					Toast.makeText(getApplicationContext(),getResources().getString(R.string.unlogin),Toast.LENGTH_SHORT).show();
	...
	private void displayFrameworkBugMessageAndExit() {
		...
		builder.setMessage(getResources().getString(R.string.openCameraAccess));
